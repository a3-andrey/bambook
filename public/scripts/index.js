...
$(window).on('click', (e) => {
  if($('.search-form input').hasClass('active')){
    if(e.target != document.querySelector('.search-form') && e.target != document.querySelector('.search-form *')){
